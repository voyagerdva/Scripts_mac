...
#    cd ~/myscripts/findNodeOrIP
    ...
    echo ""
    # if [ -n /tmp/serverSort.txt ]
    # then
    #     echo "Введена какая-то хрень. Сделайте нормальный список имен нод и введите его сюда"
    #     find_IP_by_name
    # fi
...
function find_name_by_IP {
    ...
    cat /tmp/serverSort.txt
    echo ""
    # if [ -s /tmp/serverSort.txt ]
    # then
    #     echo "Введена какая-то хрень. Сделайте нормальный список айпишников и введите его сюда"
    #     find_name_by_IP
    # fi
